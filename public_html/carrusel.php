 ...
 */
function mostrar_carrusel($proyectos, $id) {
                ...
                <div class="carousel-item <?= $i === 0 ? 'active' : '' ?>">
                    ...
                    <div class="card bg-dark text-light border-0" style="max-width: 700px; margin: 0 auto;">
                        ...
                        <?php if (!empty($p['imagen'])): ?>
                            <img src="uploads/<?= htmlspecialchars($p['imagen']) ?>" class="d-block w-100 project-image" alt="<?= isset($p['titulo']) ? htmlspecialchars($p['titulo']) : 'Proyecto' ?>">
                        <?php endif; ?>
                        <!-- Contenido de la tarjeta -->
                        <div class="card-body">
                            <!-- Título del proyecto -->
                            <h5 class="card-title"><?= isset($p['titulo']) ? htmlspecialchars($p['titulo']) : 'Sin título' ?></h5>
